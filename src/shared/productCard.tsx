        ...
        <CardContent className=' px-1 md:px-0'>
          ...
          <div className='w-full block md:hidden'>
            <div className='mt-4 flex justify-center flex-col items-center'>
              <div>
                <h4 className='text-xl uppercase text-primary font-semibold'>
                  {product.name}
                </h4>
                {/* <p
                  className={cn(
  ...
  return (
    <Link href={`/collections/${product?.id}`} prefetch={false}>
      <div key={product.id} className='group relative'>
        ...
        {/* mobile view only */}
        <div className='mt-2 flex flex-col justify-center items-center md:hidden'>
          <div>
          ...
          <Button
            ...
            className={
              isOutOfStock
                ? "w-full rounded border-red-200 text-red-600"
                : "w-full rounded border-blue-200 text-primary hover:bg-blue-200"
            }>
