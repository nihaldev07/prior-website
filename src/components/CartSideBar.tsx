...
const CartSideBar: React.FC<CartSideBarProps> = () => {
  const { removeFromCart, updateToCart, cart } = useCart();
  ...
  return (
    <>
      <button
        ...
        className=' sm:mx-5 flex items-center gap-1 rounded-full bg-neutral-100 p-2 text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75'>
