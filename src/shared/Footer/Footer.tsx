      ...
      <div className='mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32'>
        <div className='xl:grid xl:grid-cols-4 xl:gap-8'>
          ...
          <div className='xl:col-span-1'>
            ...
            <p className='mt-4 text-sm font-serif leading-6 text-neutral-400 tracking-wide max-w-xs'>
              Your priority in fashion. Premium shoes, bags, and accessories
              delivered across Bangladesh.
            </p>
          </div>

          {/* Navigation Columns */}
          <div className='mt-10 xl:mt-0 xl:col-span-3 grid grid-cols-2 gap-8 md:grid-cols-4'>
            <div>
        ...
        <div className='mt-16 border-t border-neutral-800 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24'>
          ...
          <p className='mt-8 text-xs font-serif leading-5 text-neutral-500 md:order-1 md:mt-0 tracking-wide'>
            &copy; 2026 Prior Your Priority. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
