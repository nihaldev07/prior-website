  ...
  return (
    <div className=''>
      <div
        ...
        <div className='pr-4 pt-10 lg:basis-1/3 xl:basis-1/4 hidden md:block'>
          <SidebarFilters
            filterData={filterData}
            categories={distictFilterValues.categories}
            colors={distictFilterValues.colors}
        ...
        <div className='relative flex-1'>
          ...
          {/* </div> */}
          <div className='grid flex-1 gap-x-2 md:gap-x-8 gap-y-2 md:gap-y-10 grid-cols-2 xl:grid-cols-3 '>
            {!loading &&
