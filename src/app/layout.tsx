...
export const metadata: Metadata = {
  ...
  verification: {
    google: "jvPouzw1sLr0x6buuLhw60KjxFawNswbuz6i3anqcV0",
  },
};
  ...
  return (
    <html lang='en'>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','${process.env.NEXT_PUBLIC_GTM_ID || 'GTM-T2HZLQ22'}');
            `,
          }}
        />
      ...
      <body className={`${notoSansDevanagari.variable}`}>
        ...
        <noscript>
          <iframe
            src={`https://www.googletagmanager.com/ns.html?id=${process.env.NEXT_PUBLIC_GTM_ID || 'GTM-T2HZLQ22'}`}
            height='0'
            width='0'
