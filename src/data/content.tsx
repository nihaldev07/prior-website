...
export const headerSection = {
  ...
  heading: "Women's Shoes & Bags for Every Occasion",
  description:
    "Explore our curated collection of stylish ladies' shoes and fashionable bags, designed to elevate your look for any occasion. Discover timeless elegance and modern sophistication in every step.",
};
